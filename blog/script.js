...
let blogName = "ndrg's blog";
let authorName = "nediorg";
let authorLink = "https://nediorg.github.io"; // Enter your website, social media, etc. Some way for people to tell you they like your blog! (Leaving it empty is okay too)
...
let recentPostListHTML = "<h2>Недавние посты:</h2><ul>";
